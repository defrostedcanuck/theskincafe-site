...
- **Milestone 1 (this milestone) — $2,000** *(regularly $3,500)* — polish existing site, add "Our Community" placeholder, add "Behind the Glow — Coming Soon" teaser with email capture, SEO baseline, provision client-owned infrastructure (Vercel/Resend/Cloudflare).
- **Milestone 2 (future) — $2,000** — Payload CMS with dedicated Neon DB, "Behind the Glow" content hub, homepage content strip, newsletter infrastructure, admin training.
...
- [ ] "Behind the Glow — Coming Soon" teaser block with email capture via Resend
...
- Newsletter infrastructure beyond signup form — deferred to Milestone 2
